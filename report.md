...
To optimize the performance of the advanced model, we also performed **hyperparameter tuning**. The hyperparameters evaluated for the model are as follows (which I learned from https://www.kaggle.com/code/bextuychiev/lgbm-optuna-hyperparameter-tuning-w-understanding):
```
param_grid = {
